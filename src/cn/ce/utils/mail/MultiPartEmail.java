 ...
 * @version $Id: MultiPartEmail.java,v 1.1 2011/03/25 03:13:01 wangjing Exp $
 */
public class MultiPartEmail extends Email {
	 ...
	 * @return The email.
	 * @throws EmailException
	 *             An error occured while adding the part.
	 * @since 1.0
	 */
	 ...
	 * 
	 * @param url
	 *            The URL of the file (may be any valid URL).
	 * @param name
	 *            The name field for the attachment.
	 * @param description
	 ...
	 * 
	 * @param ds
	 *            A DataSource interface for the file.
	 * @param name
	 *            The name field for the attachment.
	 * @param description
	 *            A description for the attachment.
	...
	public MultiPartEmail attach(DataSource ds, String name,
			String description, String disposition) throws EmailException {
	 ...
	 *             An error occured while getting the primary body part.
	 * @since 1.0
	 */
