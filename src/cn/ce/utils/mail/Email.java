 ...
 * @version $Revision: 1.1 $ $Date: 2005-09-07 12:56:41 +0200 (Wed, 07 Sep 2005)
 *          $
 * @version $Id: Email.java,v 1.1 2011/03/25 03:13:01 wangjing Exp $
 */
public abstract class Email {
	 ...
	 * 
	 * @param newAuthenticator
	 *            the <code>Authenticator</code> object.
	 * @see Authenticator
	 * @since 1.0
	 */
	...
	public void setContent(Object aObject, String aContentType) {
		...
		if (EmailUtils.isEmpty(aContentType)) {
			...
			if (charsetPos != -1) {
				...
				int intCharsetEnd = aContentType.toLowerCase().indexOf(" ",
						charsetPos);
	 ...
	 *             thrown when host name was not set.
	 * @since 1.0
	 */
	 ...
	 * @throws EmailException
	 *             Thrown when the address supplied or name were invalid.
	 */
	private InternetAddress createInternetAddress(String email, String name)
		...
		try {
			...
			// Using this instead of new InternetAddress(email, name, [charset])
			// makes
	...
	public void buildMimeMessage() throws EmailException {
		try {
			...
			if (this.replyList.size() > 0) {
				this.message.setReplyTo(this
						.toInternetAddressArray(this.replyList));
			}
	...
	public String sendMimeMessage() throws EmailException {
		...
		try {
			...
			String msg = "Sending the email to the following server failed : "
					+ this.getHostName() + ":" + this.getSmtpPort();
	 ...
	 * 
	 * @param date
	 *            Date to use as the sent date on the email
	 * @since 1.0
	 */
	...
	protected InternetAddress[] toInternetAddressArray(List list) {
		InternetAddress[] ia = (InternetAddress[]) list
	 ...
	 * 
	 * @param newPopBeforeSmtp
	 *            Wether or not to log into pop3 server before sending mail.
	 * @param newPopHost
	 *            The pop3 host to use.
	 * @param newPopUsername
	 *            The pop3 username.
	 * @param newPopPassword
	 *            The pop3 password.
	 * @since 1.0
	 */
