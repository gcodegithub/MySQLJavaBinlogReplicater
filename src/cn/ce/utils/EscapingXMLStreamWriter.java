...
/**
 * Delegating {@link XMLStreamWriter} that filters out UTF-8 characters that are
 * illegal in XML.
 * 
 */
public class EscapingXMLStreamWriter implements XMLStreamWriter {
	 ...
	 * {@link EscapingXMLStreamWriter#substitute}. If no illegal characters were
	...
	public void writeStartElement(String s, String s1)
	...
	public void writeEmptyElement(String s, String s1)
			throws XMLStreamException {
