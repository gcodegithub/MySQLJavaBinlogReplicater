...
public class OKPacket extends HeaderPacket {
	...
	public void fromBytes(byte[] data) throws IOException {
		...
		this.serverStatus = ByteHelper.readUnsignedShortLittleEndian(data,
				index);
		index += 2;
		// 5. read warning count
		this.warningCount = ByteHelper.readUnsignedShortLittleEndian(data,
				index);
		index += 2;
		// 6. read message.
