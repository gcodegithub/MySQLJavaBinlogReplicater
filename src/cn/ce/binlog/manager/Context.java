...
public class Context {
	...
	public void setZkClusterId(String zkClusterId) {
	...
	public AbsManager getManager() {
		return manager;
	}

	public void setManager(AbsManager manager) {
